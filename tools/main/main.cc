...
int main(int argc, const char *argv[]) {
    ...
    if (x->Error()) {
        std::cout << "[ERROR]: AST is not valid when converting from AST with Semant Info!" << endl;
        return EXIT_FAILURE;
    }
    ...
    cout << "---0004---Canonicalization..." << endl;
    ...
    cout << "---0005---Converting IR to Quad..." << endl;
    QuadProgram *qd = tree2quad(ir_canon);
    if (qd == nullptr) {
        cerr << "[ERROR]: Error converting IR to Quad" << endl;
        return EXIT_FAILURE;
    }
    ...
    // Blocking the Quad
    cout << "---0006---Blocking the quad..." << endl;
    ...
    cout << "---0007---Converting Quad to Quad-SSA..." << endl;
    QuadProgram *x5 = quad2ssa(x4);  //quad2ssa assumes blocked quad!!!
    if (x5 == nullptr) {
        cerr << "[ERROR]: Error converting Quad to Quad-SSA" << endl;
        return EXIT_FAILURE;
    }
    ...
    cout << "---0008---Preparing Quad for Register Allocation..." << endl;
    ...
    cout << "---0009---Register Allocation (Coloring)..." << endl;
    ...
    // Converting Quad to RPI
    cout << "---0010---Converting Quad to RPI" << endl;
    ColorMap *colormap = xml2colormap(file_quad_color_xml);
    cout << "\tSaving rpi code to: " << file_rpi << endl;
    quad2rpi(x6, colormap, file_rpi);
